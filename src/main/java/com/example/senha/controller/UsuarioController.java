package com.example.senha.controller;

import com.example.senha.repository.UsuarioRepository;
...
public class UsuarioController {
	...
	public ResponseEntity<java.util.List<UsuarioModel>> listarTodos(){
